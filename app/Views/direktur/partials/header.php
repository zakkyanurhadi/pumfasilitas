...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <ul class="sidebar-menu">
            <li class="sidebar-title">Menu Direktur</li>
            ...
            <li>
                <a href="<?= site_url('direktur/laporan') ?>"
            ...
            <li>
                <a href="<?= site_url('direktur/statistik') ?>"
            ...
            <li>
                <a href="<?= site_url('direktur/audit-log') ?>"
        ...
        <ul class="sidebar-menu section-bottom">
            ...
            <li>
                <a href="<?= site_url('direktur/profile') ?>"
                    class="sidebar-item <?= $uri == 'profile' ? 'active' : '' ?>">
