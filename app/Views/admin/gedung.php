    ...
    <div style="display:flex; justify-content:space-between; align-items:center;">
        ...
        <form method="get">
            <div class="search-group">
                <input type="text" name="keyword" class="form-control" placeholder="Cari gedung..."
                    value="<?= esc($keyword ?? '') ?>">
                            ...
                            <td style="display:flex; gap:0.5rem;">
                                <div class="tooltip-wrap">
                                    <a class="btn btn-sm btn-warning"
                                        onclick="openEdit(<?= $g['id'] ?>,'<?= esc($g['kode']) ?>','<?= esc($g['nama']) ?>','<?= esc($g['deskripsi']) ?>')">Edit</a>
                                    <span class="tooltip-text">Edit Data Gedung</span>
                                </div>
                                <div class="tooltip-wrap">
                                    <a href="<?= site_url('gedung/delete/' . $g['id']) ?>" class="btn btn-sm btn-danger"
                                        onclick="return confirm('Hapus gedung ini?')">Hapus</a>
