...
<head>
    ...
    <title>Reset Password - FasilitasKampusKu</title>
    ...
    <style>
        ...
        .card {
            ...
            overflow: hidden; /* Penting untuk posisi absolut */
        }
        .btn-back {
            color: #64748b;
            transition: all 0.3s;
...
<body>
    ...
    <div class="card p-4 position-relative">
        ...
        <a href="<?= base_url('login') ?>" class="btn-back position-absolute top-0 start-0 m-4" title="Kembali ke Login">
        ...
        <form action="<?= base_url('auth/change_password') ?>" method="post">
            ...
            <div class="mb-4">
                ...
                <div class="input-group">
                    ...
                    <input type="password" name="conf_password" class="form-control bg-light border-start-0" placeholder="Ketik ulang password" required>
                </div>
            </div>

            <button type="submit" class="btn btn-primary w-100 py-2 rounded-3 fw-bold shadow-sm">Simpan Password</button>
        </form>
    </div>
